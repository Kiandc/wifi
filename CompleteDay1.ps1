...
!!!DAPAT 7 UNDER51SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
conf t
 ...
 NO ip route 10.51.0.0 255.255.0.0 200.0.0.51
...
!
telephony-service
 moh "flash:/en51bacd51music51on51hold.au"
!
application
 service rivanaa flash:app-b-acd-aa-3.0.0.2.tcl
  ...
  param welcome-prompt flash:en51bacd51welcome.au
...
http://docwiki.cisco.com/wiki/Cisco51IOS51Voice51Troubleshooting51and51Monitoring51--51Tcl51IVR51Troubleshooting
...
!
  voice register pool 1
    id mac a475.b976.ec06
    number 1 dn 1
    dtmf-relay sip-notify
    username 5175 password 5175
    codec g711ulaw
!
  voice register pool 2
    id mac 5409.1056.AA2F
    number 1 dn 2
    dtmf-relay sip-notify
    username 5176 password 5176
    codec g711ulaw
!
